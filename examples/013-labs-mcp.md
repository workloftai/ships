...
Workloft Labs has been live as an HTTP API since 8 May with three keys issued, all internal. Zero external uptake. Sunday afternoon we turned it into a hosted MCP server: one JSON snippet in any agent client and our curated AI paper picks show up as tools. The same build also fixed three smaller things that had been quietly killing adoption.
...
- API server: `/home/workloft/labs-api/server.py`
- Local MCP variant (stdio): `/home/workloft/labs-api/labs_mcp.py`
- Data spine: `/home/workloft/research/arxiv-watch/data/arxiv-YYYY-MM-DD.top.json`
- Article: [workloft.ai/ships/labs-mcp-2026-05-24.html](https://workloft.ai/ships/labs-mcp-2026-05-24.html)
