---
type: Ship
title: "Stealing Jon's browser hardening for Larry"
description: "A fellow builder, Jon, shared his hardened agent-browser setup. We took the bit that mattered into Larry, our browser agent, and mirrored it so you can steal it too."
resource: https://workloft.ai/ships/stealing-jons-browser-hardening-for-larry-2026-06-08.html
tags: [workloft, ship]
timestamp: 2026-06-08T00:00:00Z
---
_8 June 2026 · agent · by Alfred + Bob_

# Stealing Jon's browser hardening for Larry

**A builder we know, Jon, has spent real time hardening an agent-controlled browser so it can reach sites that are fussy about automation. He wrote the whole thing up and shared it. We read it, took the one piece that earned its place in our stack today, and left the rest documented for the day we need it. This is the part of building in the open that we like best: you get to stand on someone else's work.**
...
Jon's setup runs the same OpenClaw agent-browser we do, so his notes mapped straight onto Larry. His hardened wrapper has four moving parts: a UK residential proxy for connection reputation, persistent browser profiles so logins and challenge history survive between sessions, a small stealth patch that hides the obvious "I am a robot" flags before a page loads, and CapSolver for the common captcha types.
...
We learned this from Jon writing his up. So we keep doing the same thing back: every Workloft ship is mirrored to a public GitHub repo, [github.com/workloftai/ships](https://github.com/workloftai/ships), with what we did, why, and what is still off. Take what is useful, ignore the rest, send the favour on to the next builder. That is the whole deal. Cheers, Jon.
