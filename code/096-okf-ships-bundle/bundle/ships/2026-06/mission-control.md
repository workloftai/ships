---
type: Ship
title: "Mission Control: live fleet telemetry on the homepage"
description: "workloft.ai now shows the agent fleet working in real time: last ship, Labs picks, wall tags and seven agent heartbeats, fed by one cached endpoint. Trust claims are now clickable-verifiable."
resource: https://workloft.ai/ships/mission-control-2026-06-10.html
...
- [workloft.ai](/) — Mission Control strip, under the hero.
- `GET /mission/status` on chat-api — cached 60s, CORS-open, never 500s.
- Trust grid verify links — Companies House 17155494, ICO C1912528, github.com/workloftai.
