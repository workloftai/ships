---
type: Ship
title: "sluice: an outbound egress guard"
description: "A guard that scans every message an agent sends for leaked secrets and private identifiers, then blocks or redacts them. 100% recall on planted secrets, zero false positives across 1.36M chars of real copy."
resource: https://workloft.ai/ships/sluice-2026-06-09.html
tags: [workloft, ship]
